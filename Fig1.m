...
xlabel('x/m');
ylabel('y/m');
% set操作在image中是如下，但在plot里xtick是实际值而非矩阵序号。
set(gca,'xtick',linspace(1,M,5),'xticklabel',sprintfc('%g',linspace(-a,a,5)),...
'ytick',linspace(1,N,5),'yticklabel',sprintfc('%g',linspace(b,-b,5)));
subplot(2,5,2)
...
'ytick',linspace(1,M,5),'yticklabel',sprintfc('%g',linspace(a,-a,5)));
subplot(2,5,6)
